...
const pandaVideo =
  "https://www.dropbox.com/scl/fi/jo5tk1r07lecgdktcjbgg/Video.mp4?rlkey=vrq87k2vq6wjzf6a7rktwyiyi&st=13newsf8&dl=1";
      ...
      >
        {pandaVideo ? (
                ...
                <div
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow =
                      "0 0 0 18px rgba(0,191,99,0.15)";
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.transform = "scale(1)";
                    e.currentTarget.style.boxShadow =
                      "0 0 0 12px rgba(0,191,99,0.2)";
                  }}
                >
                  <div
                    style={{
          ...
          >
            ...
            >
              Import your video and replace{" "}
              <code style={{ color: "#00bf63" }}>pandaVideo</code>
            </p>
          </div>
        )}
      </div>
